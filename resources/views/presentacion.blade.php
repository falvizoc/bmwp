...
<table style="max-width: 200px; padding: 10px; margin: 0 auto; border-collapse: collapse;">
    ...
    <tr>
        <td colspan="2" style="background-color: #0a4c98; text-align: center; padding: 0;">
            <a href="https://bitmovil.mx" class="" target="_blank">
                <img width="28%" style="margin: 2.5%; align-content: center;" src="https://bitmovil.mx/assets/img/Bitmovil-LOGO-03.png" alt="Bitmovil">
            </a>
        </td>
    </tr>
    <!-- /Fin Encabezado -->
    ...
    <tr>
        <td colspan="2">
            ...
            <p style="font-family: sans-serif; color: #b3b3b3; font-size: 12px; text-align: center;margin: 30px 0 0">Bitmovil 2022</p>
        </td>
    </tr>
    <!--/Footer -->
</table>
